<template>
        ...
        <!--Espace bouton-->
            ...
            <div class = " h-auto w-full flex  justify-center mt-8 border-t-2 border-white">
                ...
                <button id="pause" class="bg-white  hover:bg-black border border-white hover:text-white rounded w-12 h-12 text-black mr-8 mt-4 ripple">
                    <i class="fa fa-pause fa-2x"></i>
                </button>

                <button id="stop" class="bg-white  hover:bg-black border border-white hover:text-white rounded w-12 h-12 text-black mr-8 mt-4 ripple">
